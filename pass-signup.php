                ...
                <form method ="POST">
                  <div class="login-form">
                    ...
                    <div class="form-group">
                      <input class="form-control" name="pass_fname" type="text" pattern="[A-Za-z]*" placeholder="Enter Your First Name" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <input class="form-control" name="pass_lname" type="text"pattern="[A-Za-z]*" placeholder="Enter Your Last Name" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <input class="form-control" name="pass_phone" type="text"pattern="[0-9.]+" placeholder="Enter Your Phone Number" autocomplete="off">
                    </div>
                    <div class="form-group">
