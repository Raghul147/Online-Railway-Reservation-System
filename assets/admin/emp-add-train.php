                  ...
                  <form method ="POST">
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="name" pattern="[A-Za-z]*"id="inputText3" type="text" placeholder="Enter Train Name">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="current"  id="inputText3" type="text" placeholder="Enter Departure/Time">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Arrival/Time</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="destination"  id="inputText3" type="text" placeholder="Enter Arrival/Time">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Date</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="time" id="inputText3" type="text" placeholder="Enter Date">
                      </div>
                    </div>
                    <div class="form-group row">
